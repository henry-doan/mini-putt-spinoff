...
//18 complete holes!
//Over 5000 votes and 2750+ spin-offs! I never thought Mini Putt would be so successful! Thank you everyone who voted! It means alot, really. I also love hearing all of your feedback; it is both helpful and encouraging.

/**
1. Click to drop the ball into the dark green zone.
2. Draw the putter back for longer putts and click to release
3. Watch out for walls, slopes, bunkers, and water.
4. Get the ball into the hole to proceed to the next hole
5. The slower the ball is moving, the less accurate it has to
   be to get in the hole.
6. I would suggest TIPS for first-time players
7. Thanks for playing. Enjoy!
**/

//Based on http://www.mini-putt.org/
